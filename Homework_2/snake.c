...
int main() {
    ...
    while (1) {
        ...
        printSnake();
        ch = getch();
        if (ch == 'w' || ch == 'W' || ch == 'ц' || ch == 'Ц' || ch == KEY_UP)
            last = 'w';
        else if (ch == 's' || ch == 'S' || ch == 'ы' || ch == 'Ы' || ch == KEY_DOWN)
            last = 's';
        else if (ch == 'a' || ch == 'A' || ch == 'ф' || ch == 'Ф' || ch == KEY_LEFT)
            last = 'a';
        else if (ch == 'd' || ch == 'D' || ch == 'в' || ch == 'В' || ch == KEY_RIGHT)
            last = 'd';
        else if (ch == 27) {
            clear;
            endwin();
